...
import 'package:hotel_book_dashboard/screens/home_page.dart';
import 'package:hotel_book_dashboard/screens/login_page.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:get/get.dart';
import 'package:hotel_book_dashboard/widgets/loading.dart';
import 'package:hotel_book_dashboard/widgets/snackbar.dart';
...
class AuthController extends GetxController {
  ...
  void register() async {
if(name.text.isNotEmpty && email.text.isNotEmpty && password.text.isNotEmpty && repassword.text.isNotEmpty&& number.text.isNotEmpty){
    ...
    if (email.text.isNotEmpty && password.text.isNotEmpty) {
      ...
      try {
        ...
        if(e.code == 'user-not-found'){
          Get.back();
          showbar("About Login", "Login message", "You dont have a Entry Permit", false);
        }else{
          Get.back();
