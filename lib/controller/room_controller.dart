...
import 'package:hotel_book_dashboard/model/room_model.dart';
...
class RoomsController extends GetxController {
  ...
  late TextEditingController type, price, number, description;
  auth.User? user;
  ...
  void editRoom(
      String id, BuildContext context, String type1, int price1, String desc) {
    final GlobalKey<FormState> formKey = GlobalKey<FormState>();
    final data = MediaQuery.of(context);
    type.text = type1;
