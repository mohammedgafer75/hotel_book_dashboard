...
import 'package:hotel_book_dashboard/controller/customer_controller.dart';
...
class CustomerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<CustomersController>(
  ...
  builder: (logic) {
    return logic.loading.value ? SizedBox(
      ...
      child: Stack(
          children: [
          logic.users.isEmpty?
          const Center(child: Text('No Cutomers founded'),):
          ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text('Number: ${logic.users[index].number}'),
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          // IconButton(onPressed: () {}, icon: const Icon(Icons.edit)),
                          IconButton(onPressed: () {
                            logic.deleteCustomer(logic.users[index].id!);
